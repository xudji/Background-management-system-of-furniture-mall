  ...
  <div>
    <el-card class="card" shadow="never">
      ...
      <el-table border :data="brandList" style="width: 100%">
        <el-table-column v-loading="loading" fixed="left" type="index" prop="date" label="序号" align="center">
        </el-table-column>
        ...
        <el-table-column label="展示状态" align="center" width="200">
          ...
          <template slot-scope="scope">
            <p>
              是否展示:
              <el-switch v-model="scope.row.showStatus" size="small" :active-value="1" :inactive-value="0"
        ...
        <el-table-column label="专区大图" align="center" width="200">
          <template slot-scope="scope">
      ...
      <el-pagination :current-page="pagniationParams.currentPage" :page-sizes="pagniationParams.pageSizes"
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="产品数量" prop="orderCount">
              <el-input v-model="addForm.productCount" placeholder="产品数量"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="是否展示" prop="status">
              <el-switch v-model="addForm.showStatus" :active-value="1" :inactive-value="0"></el-switch>
            </el-form-item>
          </el-col>

          <el-col :span="12">
            <el-form-item label="是否为品牌制造商" prop="status">
              <el-switch v-model="addForm.factoryStatus" :active-value="1" :inactive-value="0"></el-switch>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item size="mini" label="上传专区大图" prop="pic">
              <el-upload class="avatar-uploader" :action="uploadUrl1" :headers="uploadHeaders" :show-file-list="false"
...
export default {
  ...
  methods: {
    ...
    getBrandList() {
      this.loading = true
      brandPageList(this.pagniationParams.start, this.pagniationParams.limit).then((res) => {
    ...
    handleCurrentChange(val) {
      //  console.log(e)
      this.pagniationParams.currentPage = val;
      this.getBrandList()
    },
    // 改变展示状态
    switchCode(row) {
