  ...
  <div class="normal-menu-form">
    <el-form ref="form" :model="form" :rules="rules" label-width="80px" :inline="false" size="normal">
      <el-form-item label="上级菜单" prop="pid">
        <el-cascader ref="menuTree" v-model="form.pid" :options="menuOptions" size="small"
          :props="{ expandTrigger: 'hover', emitPath: false, checkStrictly: true, label: 'title', value: 'id' }"
          clearable @change="menuTreeChange" />
      </el-form-item>

      <el-form-item label="路由名称" prop="name">
        <el-input v-model="form.name" size="small" :rules="rules.name" placeholder="前端路由name,唯一" />
      </el-form-item>

      <el-form-item label="路径" prop="path">
        <el-input v-model="form.path" size="small" :rules="rules.path" placeholder="前端路由path,忽略父节点路径" />
      </el-form-item>
      <el-form-item label="组建路径" prop="component">
        <el-input v-model="form.component" :rules="rules.component" size="small"
          placeholder="前端路由组件路径,比如@/views/foo/foo.vue" />
      </el-form-item>

      <el-form-item label="重定向">
        <el-input v-model.number="form.redirect" size="small" placeholder="redirect属性" />
      </el-form-item>
      <el-row :gutter="20">
        <el-col :span="12" :offset="0">
          <el-form-item label="排序">
            <el-input-number v-model.number="form.sort" size="small" placeholder="排序:值越大,越靠前" />
          </el-form-item>
        </el-col>
        <el-col :span="12" :offset="0">
          <el-form-item label="层级">
            <el-input-number v-model.number="form.level" size="small" placeholder="层级" />
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-form-item label="meta属性" size="normal">
        <el-row v-for="meta in metaList" :key="meta.tempId" style="margin-left: 0" :gutter="30">
          ...
          <el-col :span="6" :offset="0">
            ...
            <el-button type="text" style="color: red" size="mini" icon="el-icon-minus"
